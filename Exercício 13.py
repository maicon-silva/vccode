...
print("Para fazer-mos o cálculo do volume da caixa d'água cilindrica são necessários os valores do raio e a altura.")
...
# Mostra o resultado.
print(f"O valor do volume da caixa d'água é {volume_caixa}.")